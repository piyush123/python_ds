...
class ClusterSet(object):
    ...
    def findClosest(self, linkage):
        ...
        for ci in self.getClusters():
            for cj in self.getClusters():
                if ci != cj:
                    dist = linkage(ci,cj)
                    if not sim:
                        sim = [ci, cj, dist]
...
def test():
    print 'hey 1'
    points = buildCityPoints('/Users/piyushshah/OneDrive/Documents/Python/ProblemSet6/cityTemps.txt', False)
    print 'hey'
...
def test1():
    points1 = buildCityPoints(r"/Users/piyushshah/OneDrive/Documents/Python/ProblemSet6/cityTemps1.txt", False)
    points2 = buildCityPoints(r"/Users/piyushshah/OneDrive/Documents/Python/ProblemSet6/cityTemps2.txt", False)
    
    #print points1
    #print points2
    c1 = Cluster(points1, "1")
    c2 = Cluster(points2, "2")
    print c1.singleLinkageDist(c2)
    print c1.maxLinkageDist(c2)
    print c1.averageLinkageDist(c2)
    print c1.mysteryLinkageDist(c2)
    

def test3():
    
    points = buildCityPoints(r"/Users/piyushshah/OneDrive/Documents/Python/ProblemSet6/test.txt", False)
...
def test4():
    ...
    points = buildCityPoints(r"/Users/piyushshah/OneDrive/Documents/Python/ProblemSet6/test1.txt", False)
    hCluster(points, Cluster.singleLinkageDist, 3, False)
    hCluster(points, Cluster.maxLinkageDist, 3, False)
    hCluster(points, Cluster.averageLinkageDist, 3, False)
    hCluster(points, Cluster.mysteryLinkageDist, 3, False)
