...
class SimpleVirus(object):
    ...
    def reproduce(self, popDensity):
        ...
        if stoch <= prob:
            s = SimpleVirus(self.maxBirthProb, self.clearProb)
            return s
        else:
...
def simulationWithoutDrug(numViruses, maxPop, maxBirthProb, clearProb,
    ...
    for sim in range(numTrials):
        ...
        for i in range(300):
            patient.update()
            vpop.append(patient.getTotalPop())
            virusList[i] += patient.getTotalPop()
 
    avgX = [x / float(numTrials) for x in virusList]

    pylab.plot(avgX, label = 'viruses')
...
class TreatedPatient(Patient):
    ...
    def addPrescription(self, newDrug):
        ...
        """
        self.drugsAdministered[newDrug] = True
    ...
    def getPrescriptions(self):
        ...
        patient.
        """
        return self.drugsAdministered.keys()
    ...
    def getResistPop(self, drugResist):
        ...
        i = 0
        for drug in self.drugsAdministered:
            resist = True
            for v in self.viruses:
